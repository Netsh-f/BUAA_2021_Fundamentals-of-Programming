...
inline int equal(int a1,int b1,int a2,int b2){
	return a1*b2==a2*b1;
}

inline int chong(int a1,int b1,int c1,int a2,int b2,int c2){
	return equal(a1,b1,a2,b2)&&equal(a1,c1,a2,c2);
}

inline int ping(int a1,int b1,int c1,int a2,int b2,int c2){
	return equal(a1,b1,a2,b2)&&!equal(a1,c1,a2,c2);
}
